...
class SignUpViewController: UIViewController {
    ...
    let confirmPasswordTextField = LineTextField(font: .avenir20())
...
extension SignUpViewController {
    private func setupConstraints() {
        ...
        let confirmPasswordStackView = UIStackView(arrangedSubviews: [confirmPasswodLabel, confirmPasswordTextField], axis: .vertical, spacing: 10)
